...
const file = path.resolve('.worker-build-marketplace/index.js');
...
if (!source.includes("'https://nexaurenstory.com'")) throw new Error('Marketplace CORS hardening failed: marker not found');
