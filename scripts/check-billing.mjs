...
for (const column of ['current_period_start','current_period_end','cancel_at_period_end','subscription_cycles','idx_subscription_cycles_subscription_key']) {
...
console.log('[billing] Architecture, webhook lifecycle and refund checks passed.');